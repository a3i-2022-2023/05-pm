---
title: AI in the Industry Tutorials (Probabilistic Models)
...
This tutorial in particular tackles the problem of how the behavior of ML learning models (neural networks in particular) can be dramatically altered by taking advantage of proper probabilistic modeling.
...
```sh
git clone https://github.com/a3i-2022-2023/05-pm
```
